...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/SamplingAndEsimation/excercise/figure/Rproject.png}
\vspace{.5cm}
\centering
...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/SamplingAndEsimation/excercise/figure/Ralt.png}
\begin{itemize}
...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/SamplingAndEsimation/excercise/figure/RStudio.png}
\vspace{.5cm}
\begin{center}
...
\item \R{?\emph{command}}
\end{itemize}
\includegraphics[width=\textwidth, height=4cm]{H:/Sand_Summerschool/SamplingAndEsimation/excercise/figure/rhlep.png}
\begin{itemize}
...
\end{center}
\begin{scriptsize}
<<echo=TRUE,eval=TRUE,cache=CA,out.height=4>>=
...
\includegraphics[width=\linewidth, height=5cm]{H:/Sand_Summerschool/SamplingAndEsimation/excercise/figure/Rpackages.png}
\vspace{.25cm}
...
<<echo=T,eval=TRUE,fig=T,height=4,cache=CA>>=
set.seed(42)
x <- rnorm(1000,0,1)
plot(x)
@
...
<<echo=T,eval=TRUE,fig=T,height=4>>=
hist(x)
@
\end{column}
\end{columns}
...
\begin{center}
\pgfdeclareimage[width=.6\textwidth]{SampleHelp}{H:/Sand_Summerschool/figure/SampleHelp.PNG}
\pgfuseimage{SampleHelp}

\pgfdeclareimage[width=.6\textwidth]{SampleWhat}{H:/Sand_Summerschool/figure/SampleWhat2.PNG}
\pgfdeclareimage[width=.6\textwidth]{SampleHow}{H:/Sand_Summerschool/figure/SampleHow.PNG}
\pgfdeclareimage[width=.6\textwidth]{SampleReplacement}{H:/Sand_Summerschool/figure/SampleReplacement.PNG}
...
\begin{footnotesize}
<<echo=T,eval=T,cache=CA,tidy=TRUE>>=
id <- 1:10000
set.seed(42)
...
\begin{frame}[fragile]{Simple Example on Sampling}
%\frametitle{\vspace{-.05cm}\begin{center}\footnotesize{Simple Example on Sampling}\end{center}}
<<echo=T,eval=T,tidy=TRUE,fig=T,height=4>>=
...
<<echo=T,eval=T,tidy=TRUE,cache=T>>=
library(sampling)
set.seed(42)
...
\begin{frame}[fragile]{Simple Example on Sampling}{the sampling package}
%\frametitle{\vspace{-.05cm}\begin{center}\footnotesize{Simple Example on Sampling}\\ \scriptsize{the sampling package}\end{center}}
<<echo=T,eval=T,tidy=TRUE,cache=CA>>=
par(mfrow=c(1,2))
@
\begin{minipage}{5.5cm}
<<echo=F,eval=T,tidy=TRUE,fig=T>>=
plot(density(my.pop$iq),main = "My first density plot"
     , xlab = "IQ")
abline(v=mean(my.pop$iq), col = "black")
lines(density(my.samp.SRS$iq),col = "red",lwd=2)
