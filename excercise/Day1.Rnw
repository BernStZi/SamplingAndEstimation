...
\includegraphics[height=1cm,width=2cm]{H:/Sand_Summerschool/GESIS_Logo_kompakt_en.jpg}
\end{textblock*}}
...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/figure/Rproject.png}
\vspace{.5cm}
\centering
...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/figure/Ralt.png}
\begin{itemize}
...
\includegraphics[width=\linewidth, height=6cm]{H:/Sand_Summerschool/figure/RStudio.png}
\vspace{.5cm}
\begin{center}
...
\item \R{?\emph{command}}
\end{itemize}
\includegraphics[width=\textwidth, height=4cm]{H:/Sand_Summerschool/figure/rhlep.png}
\begin{itemize}
...
\includegraphics[width=\linewidth, height=5cm]{H:/Sand_Summerschool/figure/Rpackages.png}
\vspace{.25cm}
