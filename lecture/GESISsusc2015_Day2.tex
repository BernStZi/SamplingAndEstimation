...
\usepackage{alltt}
>>>>>>> a56f9b9c3eb0c8459041bce3355bd6e12858ee52:lecture/GESISsusc2015_Day2.tex
\usepackage{etex}
...
\usepackage{Sweave}
\begin{document}
\input{GESISsusc2015_Day2-concordance}
\begin{Schunk}
\begin{Sinput}
> library(knitr)
...
\end{document}
>>>>>>> e61aa6225c2b98cae04cbd2d96669195f6860fea
