...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Stratification and Allocation}
...
<<strRS.sample, echo=TRUE, message=FALSE, tidy=FALSE,size='footnotesize'>>=
############################# Input ###############################
#strind: the stratification varaible; a population length vector.
#nh:     allocation; a vector with elements named after the strata.
#replace: logical; sampling with or without replacement.
############################# Output ##############################
#A numeric vector containing the sampled 
#rows of the population dataset.
