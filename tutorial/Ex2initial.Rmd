...
- The dataset `apistrat` is a sample of schools from `apipop` stratified by `stype`. Assuming the selection within the strata was done by SRS, define a `svydesign` a survey object and calculate a point and variance estimate for the mean of `api00`. 
