...
\includegraphics[width=\linewidth, height=6cm]{../../../tutorial/figure/Ralt.png}
\begin{itemize}
...
\includegraphics[width=\linewidth, height=6cm]{../../../tutorial/figure/RStudio.png}
\vspace{.5cm}
\begin{center}
...
\includegraphics[width=\linewidth, height=5cm]{../../../tutorial/figure/Rpackages.png}
\vspace{.25cm}
...
\begin{center}
\pgfdeclareimage[width=.6\textwidth]{SampleHelp}{../../../tutorial/figure/SampleHelp.PNG}
\pgfuseimage{SampleHelp}

\pgfdeclareimage[width=.6\textwidth]{SampleWhat}{../../../tutorial/figure/SampleWhat2.PNG}
\pgfdeclareimage[width=.6\textwidth]{SampleHow}{../../../tutorial/figure/SampleHow.PNG}
\pgfdeclareimage[width=.6\textwidth]{SampleReplacement}{../../../tutorial/figure/SampleReplacement.PNG}
